...
If you'd like to use LaTeX colours which invert similarly, use the approach shown in the [Custom Colors - Light and dark mode different colors using a color filter](filter)
